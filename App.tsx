...
const App: React.FC = () => {
  ...
  const getInitialStep = (): 'home' | 'step1' | 'step2' => {
    ...
    return (step === 'home' || step === 'step1' || step === 'step2') ? step : 'home';
  };

  const [currentStep, setCurrentStep] = useState<'home' | 'step1' | 'step2'>(getInitialStep());
  const [sceneImage, setSceneImage] = useState<File | null>(null);
  const [selectedProduct, setSelectedProduct] = useState<{id: string, name: string, imageUrl: string, size: string, type: 'plant' | 'tile'} | null>(null);
  ...
  const handleProductSelect = useCallback((product: {id: string, name: string, imageUrl: string, size: string, type: 'plant' | 'tile'}) => {
          ...
          <div className="mb-8">
            ...
            <div className="card p-2 max-w-2xl mx-auto">
              <img 
                ...
                alt={isResultReady ? "Your design result" : "Your uploaded space"} 
