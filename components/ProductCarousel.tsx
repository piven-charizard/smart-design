...
const ProductCarousel: React.FC<ProductCarouselProps> = ({ products, onSelect, selectedProducts }) => {
    ...
    return (
        <div className="relative w-full">
            ...
            <div className="flex justify-center mt-4 space-x-1">
                <div className={`w-2 h-2 rounded-full ${canScrollLeft ? 'bg-gray-400' : 'bg-gray-200'}`}></div>
                <div className={`w-2 h-2 rounded-full ${canScrollRight ? 'bg-gray-400' : 'bg-gray-200'}`}></div>
            </div>
        </div>
    );
};
